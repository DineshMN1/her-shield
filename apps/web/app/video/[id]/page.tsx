...
export default function VideoCallPage() {
  ...
  const roomName = `hershield-${appointmentId}`;
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-white font-semibold">{appointment?.doctorName || appointment?.patientName || 'Video Consultation'}</h1>
                <p className="text-gray-400 text-sm">{appointment?.specialty || 'Consultation'}</p>
              </div>
            </div>
            {inCall && (
              <button
        ...
        {inCall ? (
          ...
          <div className="max-w-2xl mx-auto px-4 py-12">
            ...
            <p className="text-center text-gray-500 text-sm mt-4">
              Both you and the doctor will join the same room automatically
            </p>
          </div>
        )}
      </div>
