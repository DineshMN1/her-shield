...
import { Heart, Video, MessageCircle, AlertCircle, Activity, Star, CheckCircle, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        >
          <h2 className="text-4xl font-black text-center mb-12 gradient-text">Trusted by Mothers Everywhere</h2>
          <div className="grid md:grid-cols-4 gap-12 text-center">
            {stats.map((stat, i) => (
              <div key={i}>
                <div className="text-6xl font-black mb-3" style={{ color: stat.color }}>{stat.value}</div>
...
const stats = [
  { value: '24/7', label: 'Emergency Support', color: '#ef4444' },
  { value: '500+', label: 'Verified Doctors', color: '#8b5cf6' },
  { value: '10K+', label: 'Happy Mothers', color: '#ff6b9d' },
